...
export default function Hospital_TodayTokens(){
  ...
  useEffect(() => { load() }, [departmentId, doctorId, tokenType])
  ...
  const exportPdf = async () => {
    try{
      ...
      const filters = `Date: ${new Date().toISOString().slice(0,10)}  •  Dept: ${depName}  •  Doctor: ${docName}  •  Type: ${tokenType}`
