...
export default function Hospital_TokenHistory() {
  ...
  useEffect(() => { load() }, [from, to, department, doctor, tokenType])
  ...
  }, [query, from, to, department, doctor, rows, departments, doctors, tokenType])
  ...
  const exportPdf = async () => {
    try{
      ...
      const filters = `From: ${from}  •  To: ${to}  •  Dept: ${depName}  •  Doctor: ${docName}  •  Type: ${tokenType}  •  Search: ${query || '-'}`
