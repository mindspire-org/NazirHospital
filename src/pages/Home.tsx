...
export default function Home() {
  ...
  const modules = [
    {
      ...
      icon: <Stethoscope className="size-7 text-sky-600" />,
      tone: "sky" as const,
    },
    {
      to: "/lab/login",
      ...
      icon: <FlaskConical className="size-7 text-emerald-600" />,
    ...
    },
    {
      ...
      icon: <FlaskConical className="size-7 text-teal-600" />,
      tone: "teal" as const,
    },
    {
      to: "/pharmacy/login",
      ...
      icon: <Pill className="size-7 text-violet-600" />,
      tone: "violet" as const,
    },
    {
      to: "/aesthetic/login",
      title: "Aesthetic",
      description: "Aesthetic treatments, bookings, and billing.",
      icon: <Sparkles className="size-7 text-violet-600" />,
      tone: "violet" as const,
    },
    {
      to: "/finance",
      ...
      icon: <FileText className="size-7 text-amber-600" />,
      tone: "amber" as const,
    },
    {
      to: "/reception",
      ...
      icon: <PhoneIncoming className="size-7 text-teal-600" />,
      tone: "teal" as const,
    },
  ];

  const visibleModules = modules.filter(
    (m) => m.to !== "/diagnostic/login" && m.to !== "/aesthetic/login",
  );
  ...
  return (
    <div className="min-h-dvh relative overflow-hidden">
      ...
      <div
        className="home-orb secondary"
        style={{ right: "-140px", bottom: "-160px" }}
      />
        ...
        >
          <h1
            ...
            style={{
              ...
              backgroundImage:
                "linear-gradient(90deg, #0f2d5c 0%, #3b82f6 50%, #0f2d5c 100%)",
